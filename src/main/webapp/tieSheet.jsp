...
<h1 class="text-justify" style="color: white; text-align: center;">Tie Sheet</h1>
<table class="table table-primary">
<tr class="table table-primary">
<td class=" table table-primary">Red Team</td>
<td class="table table-primary">Blue Team</td>
</tr>
<%
try{
