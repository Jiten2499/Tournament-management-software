...
<button type="button" class="btn btn-outline-primary"><a href="showData.jsp"">List of Players</a></button>
<button type="button" class="btn btn-outline-primary"><a href="tieSheet.jsp"">Tie Sheet</a></button>
<h2></h2>
</div>
